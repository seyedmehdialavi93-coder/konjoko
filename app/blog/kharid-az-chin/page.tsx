...
export const metadata: Metadata = {
 title: "خرید از چین به روش صحیح — راهنمای ۲۰۲۵ | کنجوکو",
 description: "راهنمای کامل خرید از چین برای ایرانیان. بهترین کالاها، تامین کنندگان معتبر و روش خرید مطمئن از بازارهای چین با کنجوکو.",
};
   ...
   <main style={{backgroundColor: "#0a0a0a", minHeight: "100vh", color: "white", direction: "rtl"}}>
     <div style={{maxWidth: "800px", margin: "0 auto", padding: "60px 20px"}}>
       ...
       <div style={{backgroundColor: "#1a1a1a", borderRadius: "24px", padding: "48px", border: "1px solid #333"}}>
         ...
         <h1 style={{fontSize: "2rem", fontWeight: "bold", marginBottom: "32px", lineHeight: "1.4"}}>خرید از چین به روش صحیح — راهنمای ۲۰۲۵</h1>
         <p style={{color: "#d1d5db", lineHeight: "2", marginBottom: "24px"}}>چین بزرگترین تامین کننده کالا در جهان است. از الکترونیک گرفته تا پوشاک و لوازم خانگی، همه چیز با قیمتهای باورنکردنی در چین یافت میشود.</p>
         <h2 style={{fontSize: "1.5rem", fontWeight: "bold", marginBottom: "16px", marginTop: "40px", color: "#60a5fa"}}>چرا از چین بخریم؟</h2>
         <p style={{color: "#d1d5db", lineHeight: "2", marginBottom: "24px"}}>قیمتهای چین به دلیل هزینه تولید پایین، بسیار رقابتی است. کالاهایی که در ایران چند برابر قیمت خریداری میشوند، در چین با قیمت کارخانه در دسترس هستند.</p>
         ...
         <div style={{backgroundColor: "#111", borderRadius: "12px", padding: "24px", marginBottom: "24px"}}>
           {["الکترونیک و لوازم جانبی موبایل", "پوشاک و کفش", "ابزار و تجهیزات صنعتی", "لوازم خانگی و آشپزخانه", "اسباب بازی و لوازم ورزشی", "قطعات یدکی خودرو"].map((item) => (
         ...
         <p style={{color: "#d1d5db", lineHeight: "2", marginBottom: "32px"}}>کنجوکو با داشتن شبکه گسترده ای از تامین کنندگان معتبر در چین، بهترین قیمت و کیفیت را برای شما تضمین میکند. از پیدا کردن فروشنده تا ترخیص و تحویل کالا، همه مراحل را کنجوکو انجام میدهد.</p>
