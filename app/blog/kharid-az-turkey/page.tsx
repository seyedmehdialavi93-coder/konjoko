   ...
   <main style={{backgroundColor: "#0a0a0a", minHeight: "100vh", color: "white", direction: "rtl"}}>
     <div style={{maxWidth: "800px", margin: "0 auto", padding: "60px 20px"}}>
       ...
       <div style={{backgroundColor: "#1a1a1a", borderRadius: "24px", padding: "48px", border: "1px solid #333"}}>
         ...
         <p style={{color: "#d1d5db", lineHeight: "2", marginBottom: "32px"}}>کنجوکو با شبکه گسترده‌ای از تامین کنندگان معتبر در ترکیه، بهترین قیمت و کیفیت را برای شما تضمین میکند. کافیست درخواست خود را ثبت کنید، ما بقیه کارها را انجام میدهیم.</p>
