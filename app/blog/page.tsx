...
const posts = [
  ...
  { slug: "kharid-omde-dubai-chin", title: "راهنمای کامل خرید عمده از دبی و چین برای تاجران ایرانی ۲۰۲۵", excerpt: "راهنمای جامع خرید عمده از دبی، چین و ترکیه برای تاجران و کارخانه‌داران.", date: "۱۴۰۴/۳/۶", emoji: "🌍" },
  ...
  { slug: "tamin-konande-chin", title: "چطور تامین‌کننده معتبر در چین پیدا کنیم؟", excerpt: "راهنمای کامل پیدا کردن تامین‌کننده معتبر در چین. بهترین سایتها و روش‌های تایید اعتبار.", date: "۱۴۰۴/۳/۶", emoji: "🔍" },
