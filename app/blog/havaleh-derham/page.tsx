...
export const metadata: Metadata = {
 ...
 description: "راهنمای کامل حواله درهم برای تاجران ایرانی. نحوه ارسال درهم به دبی، هزینه‌ها و بهترین روش پرداخت ارزی با کنجوکو.",
};
   ...
   <main style={{backgroundColor: "#0a0a0a", minHeight: "100vh", color: "white", direction: "rtl"}}>
     <div style={{maxWidth: "800px", margin: "0 auto", padding: "60px 20px"}}>
       ...
       <div style={{backgroundColor: "#1a1a1a", borderRadius: "24px", padding: "48px", border: "1px solid #333"}}>
         ...
         <p style={{color: "#d1d5db", lineHeight: "2", marginBottom: "24px"}}>اگه با تاجران دبی کار میکنید، احتمالاً با مشکل پرداخت درهم روبرو شدید. کارتهای ایرانی در امارات کار نمیکنن و انتقال پول از ایران به دبی پیچیدگیهای خودش رو داره. کنجوکو این مشکل رو برای همیشه حل کرده.</p>

         <h2 style={{fontSize: "1.5rem", fontWeight: "bold", marginBottom: "16px", marginTop: "40px", color: "#60a5fa"}}>حواله درهم چیست؟</h2>
         <p style={{color: "#d1d5db", lineHeight: "2", marginBottom: "24px"}}>حواله درهم یعنی تبدیل ریال به درهم امارات و ارسال آن به حساب بانکی یا فروشنده در دبی. این روش برای پرداخت به فروشندگان اماراتی، خرید کالا از دبی و انجام معاملات تجاری با شرکتهای اماراتی استفاده میشه.</p>
         ...
         <div style={{backgroundColor: "#1e3a5f", borderRadius: "16px", padding: "32px", textAlign: "center", marginTop: "40px"}}>
           <p style={{fontSize: "1.25rem", fontWeight: "bold", marginBottom: "16px"}}>همین الان حواله درهم رو شرو